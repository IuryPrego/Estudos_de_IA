...
right by one pixel. Save the resulting file to ../data/mnist_expanded.pkl.gz.
...
if os.path.exists("data/mnist_expanded.pkl.gz"):
    ...
    with gzip.open("data/mnist_expanded.pkl.gz", "wb") as f:  # Use "wb" for binary write mode
